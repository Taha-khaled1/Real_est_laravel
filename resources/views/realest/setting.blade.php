							...
							<div class="card-body">
									...
									<div class="form-group ">
										<div class="row">
											...
											<div class="col-md-9">
												<input type="text" class="form-control"  placeholder="UserName" value="{{$setting->company_name}}" name="username" id="username">
											</div>
										</div>
									</div>
									{{-- <div class="form-group ">
									...
									<div class="form-group ">
										<div class="row">
											...
											<div class="col-md-9">
												<input type="text" class="form-control"  placeholder="Email" value="{{$setting->email}}" name="email" id="email">
											</div>
										</div>
									</div>
									<div class="form-group ">
										<div class="row">
											...
											<div class="col-md-9">
												<input type="text" class="form-control" name="Website" id="Website"  placeholder="Website" value="{{$setting->website_link}}">
											</div>
										</div>
									</div>
									<div class="form-group ">
										<div class="row">
											...
											<div class="col-md-9">
												<input type="text" class="form-control"  placeholder="phone number" value="{{$setting->company_phone}}" name="phone" id="phone">
											</div>
										</div>
									</div>
									<div class="form-group ">
									...
									<div class="form-group ">
										<div class="row">
											...
											<div class="col-md-9">
												<input type="text" class="form-control"  placeholder="twitter" value="{{$setting->twitter}}" name="twitter" id="twitter">
											</div>
										</div>
									</div>
									<div class="form-group ">
										<div class="row">
											...
											<div class="col-md-9">
												<input type="text" class="form-control"  placeholder="facebook" value="{{$setting->facebook}}" name="facebook" id="facebook">
											</div>
										</div>
									</div>
									<div class="form-group ">
									...
									<div class="form-group ">
										<div class="row">
											...
											<div class="col-md-9">
												<input type="text" class="form-control"  placeholder="linkedin" value="{{$setting->linkedin}}" name="linkedin" id="linkedin">
											</div>
										</div>
									</div>
									<div class="form-group ">
										<div class="row">
											...
											<div class="col-md-9">
												<input type="text" class="form-control" placeholder="github" value="{{$setting->github}}" name="github" id="github">
											</div>
										</div>
									</div>
