...
<section
    class="bg-no-repeat bg-center bg-cover bg-[#FFF6F0] h-[350px] lg:h-[513px] xl:h-[650px] flex flex-wrap items-center relative before:absolute before:inset-0 before:content-[''] before:bg-[#000000] before:opacity-[70%]"
    style="background-image: url('{{ URL::asset('sub_screen.jpg') }}');">
    <div class="container">
        <div class="grid grid-cols-12">
            <div class="col-span-12">
                <div class="text-center text-white relative z-10">
                    <div class="mb-5"><span class="text-base block">منشور المدونة الخاص بنا
                    </span></div>
                    <h1
                        class="font-recoleta text-[36px] sm:text-[50px] md:text-[68px] lg:text-[50px] leading-tight xl:text-2xl">
                        تفاصيل المدونة
    ...
    <div class="container">
        ...
        <div class="grid grid-cols-12 mb-[-30px] gap-[30px] xl:gap-[50px]">
            <div class="col-span-12 md:col-span-6 lg:col-span-8 mb-[30px]">
                <img src="{{ URL::asset($blogs->image) }}" class="w-auto h-auto" loading="lazy"
                    alt="Elite Garden Resedence." width="770" height="465">
                <div class="mt-[55px] mb-[35px]">
                    <span
                        class="block leading-none font-normal text-[18px] text-secondary mb-[5px] relative before:absolute before:left-0 before:top-1/2 -translate-y-1/2 before:bg-secondary before:content-[''] before:w-[3px] before:h-[3px] before:rounded-full before:block pl-[10px]">James
                ...
                <div
                    ...
                    <div class="flex flex-wrap mb-[15px]">
                        <span class="text-secondary">العلامات : </span>
                        <a class="font-light hover:text-secondary ml-[5px]" href="#">عقارات,</a>
                        <a class="font-light hover:text-secondary ml-[5px]" href="#"> منازل,</a>
                        <a class="font-light hover:text-secondary ml-[5px]" href="#">شليهات,</a>
                        <a class="font-light hover:text-secondary ml-[5px]" href="#">فيلا دوبلكس</a>
                    </div>

                    <div class="flex flex-wrap mb-[15px]">
                        <span class="text-secondary">مشاركه : </span>
                        <ul class="inline-flex items-center justify-center">
                            <li class="ml-[15px]"><a href="#"
