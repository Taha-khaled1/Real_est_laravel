        ...
        <div class="grid grid-cols-12 gap-x-[30px] mb-[-30px]">
            ...
            <div class="col-span-12 sm:col-span-6 lg:col-span-2 mb-[30px]">
                ...
                <ul class="inline-flex items-center justify-center mt-[20px]">
                    ...
                    <li class="ml-[15px]"><a href="https://twitter.com/" class="w-[26px] h-[26px] transition-all rounded-full bg-primary flex items-center justify-center hover:drop-shadow-[0px_4px_10px_rgba(0,0,0,0.25)] text-white hover:bg-secondary">
                    ...
                    <li class="ml-[15px]"><a href="https://www.instagram.com/" class="w-[26px] h-[26px] transition-all rounded-full bg-primary flex items-center justify-center hover:drop-shadow-[0px_4px_10px_rgba(0,0,0,0.25)] text-white hover:bg-secondary">
