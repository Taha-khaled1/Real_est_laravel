<footer>
        ...
        <div class="container">
            <div class="row footer-top-style">
                <div class="col-lg-4 mb-lg-0 mb-sm-5">
                    ...
                    <p class="fs-5">إنجاز العقارية شركة مصرية تأسست عام 2015 بهدف تقديم خدمات عقارية فى مجالات متعددة تشمل السكني , التجارى والسياحي . كما قامت إنجاز العقارية بضم مجموعة من المطورين العقارين ذوي المصداقية لكي تتمكن من عرض أكثر عدد من المشاريع المتميزة التي يمتلكها هؤلاء المطورين تحت سقف واحد.</p>
                ...
                <div class="col-lg-4 mb-lg-0 mb-sm-5">
                    ...
                    <ul class="links">
                        ...
                        <li class="mb-3"><a href="#" class="text-decoration-none text-light">الرابط الرابع</a></li>
                ...
                <div class="col-lg-4 mb-lg-0">
                    ...
                    <ul class="links list-unstyled p-0">
                        ...
                        <li class="mb-3 english-font"><a href="mailto:info@example.com" class="text-decoration-none text-light"> <i class="fa fa-envelope ms-2"></i>NTS@example.com</a></li>
    ...
    <div class="footer-bottom-style">
        <div class="container">
            <div class="row p-3">
                <div class="col-12">
                    <p class="text-center text-light mb-0">جميع الحقوق محفوظة لدي NTS</p>
                </div>
            </div>
        </div>
    </div>
